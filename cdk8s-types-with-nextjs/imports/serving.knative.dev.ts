...
export interface ConfigurationSpecTemplateSpec {
   ...
   *
   * @default 0` which means concurrency to the application is not limited, and the system decides the target concurrency for the autoscaler.
 ...
 * DomainMapping is a mapping from a custom hostname to an Addressable.
 *
 * @schema DomainMappingV1Alpha1
 */
export class DomainMappingV1Alpha1 extends ApiObject {
  /**
   * Returns the apiVersion and kind for "DomainMappingV1Alpha1"
   */
  public static readonly GVK: GroupVersionKind = {
  ...
  /**
   * Renders a Kubernetes manifest for "DomainMappingV1Alpha1".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: DomainMappingV1Alpha1Props = {}): any {
    return {
      ...DomainMappingV1Alpha1.GVK,
      ...toJson_DomainMappingV1Alpha1Props(props),
    };
  }

  /**
   * Defines a "DomainMappingV1Alpha1" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: DomainMappingV1Alpha1Props = {}) {
    super(scope, id, {
      ...DomainMappingV1Alpha1.GVK,
      ...props,
    });
  ...
  public toJson(): any {
    ...
    return {
      ...DomainMappingV1Alpha1.GVK,
      ...toJson_DomainMappingV1Alpha1Props(resolved),
    };
  }
}
 ...
 * @schema DomainMappingV1Alpha1
 */
export interface DomainMappingV1Alpha1Props {
  /**
   * @schema DomainMappingV1Alpha1#metadata
   */
  readonly metadata?: ApiObjectMetadata;
   ...
   * Spec is the desired state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
   *
   * @schema DomainMappingV1Alpha1#spec
   */
  readonly spec?: DomainMappingV1Alpha1Spec;

}

/**
 * Converts an object of type 'DomainMappingV1Alpha1Props' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainMappingV1Alpha1Props(obj: DomainMappingV1Alpha1Props | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_DomainMappingV1Alpha1Spec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Spec is the desired state of the DomainMapping. More info: https://github.com/kubernetes/community/blob/master/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
 *
 * @schema DomainMappingV1Alpha1Spec
 */
export interface DomainMappingV1Alpha1Spec {
  /**
   * Ref specifies the target of the Domain Mapping.
   * The object identified by the Ref must be an Addressable with a URL of the form `{name}.{namespace}.{domain}` where `{domain}` is the cluster domain, and `{name}` and `{namespace}` are the name and namespace of a Kubernetes Service.
   * This contract is satisfied by Knative types such as Knative Services and Knative Routes, and by Kubernetes Services.
   *
   * @schema DomainMappingV1Alpha1Spec#ref
   */
  readonly ref: DomainMappingV1Alpha1SpecRef;

  /**
   * TLS allows the DomainMapping to terminate TLS traffic with an existing secret.
   *
   * @schema DomainMappingV1Alpha1Spec#tls
   */
  readonly tls?: DomainMappingV1Alpha1SpecTls;

}

/**
 * Converts an object of type 'DomainMappingV1Alpha1Spec' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainMappingV1Alpha1Spec(obj: DomainMappingV1Alpha1Spec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'ref': toJson_DomainMappingV1Alpha1SpecRef(obj.ref),
    'tls': toJson_DomainMappingV1Alpha1SpecTls(obj.tls),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * This contract is satisfied by Knative types such as Knative Services and Knative Routes, and by Kubernetes Services.
 *
 * @schema DomainMappingV1Alpha1SpecRef
 */
export interface DomainMappingV1Alpha1SpecRef {
  /**
   * Address points to a specific Address Name.
   *
   * @schema DomainMappingV1Alpha1SpecRef#address
   */
  readonly address?: string;
   ...
   * API version of the referent.
   *
   * @schema DomainMappingV1Alpha1SpecRef#apiVersion
   */
  readonly apiVersion?: string;
   ...
   * Group of the API, without the version of the group. This can be used as an alternative to the APIVersion, and then resolved using ResolveGroup. Note: This API is EXPERIMENTAL and might break anytime. For more details: https://github.com/knative/eventing/issues/5086
   *
   * @schema DomainMappingV1Alpha1SpecRef#group
   */
  readonly group?: string;
   ...
   * Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
   *
   * @schema DomainMappingV1Alpha1SpecRef#kind
   */
  readonly kind: string;
   ...
   * Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
   *
   * @schema DomainMappingV1Alpha1SpecRef#name
   */
  readonly name: string;
   ...
   * Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ This is optional field, it gets defaulted to the object holding it if left out.
   *
   * @schema DomainMappingV1Alpha1SpecRef#namespace
   */
  readonly namespace?: string;
...
/**
 * Converts an object of type 'DomainMappingV1Alpha1SpecRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainMappingV1Alpha1SpecRef(obj: DomainMappingV1Alpha1SpecRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'address': obj.address,
    'apiVersion': obj.apiVersion,
 ...
 * TLS allows the DomainMapping to terminate TLS traffic with an existing secret.
 *
 * @schema DomainMappingV1Alpha1SpecTls
 */
export interface DomainMappingV1Alpha1SpecTls {
  /**
   * SecretName is the name of the existing secret used to terminate TLS traffic.
   *
   * @schema DomainMappingV1Alpha1SpecTls#secretName
   */
  readonly secretName: string;
...
/**
 * Converts an object of type 'DomainMappingV1Alpha1SpecTls' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_DomainMappingV1Alpha1SpecTls(obj: DomainMappingV1Alpha1SpecTls | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'secretName': obj.secretName,
  };
